...
if (isset($_POST['add'])) {
    ...
    $query = "INSERT INTO achat_fournitures_bureau (designation, quantite, prix_unitaire, prix_global, date_acquisition, affectation, observation, n_convention) VALUES ('$designation', '$quantite', '$prix_unitaire', '$prix_global', '$date_acquisition', '$affectation', '$observation', '$n_convention')";

    // Execute the query
    if (mysqli_query($conn, $query)) {
        header('Location:add-achat-fournitures-bureau.php?success=ajouter');
    } else {
        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Ajouter achat fournitures bureau</h3>
                        <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="execution-programme.php">Execution Programme</a></li>
                            <li class="breadcrumb-item active">Ajouter achat fournitures bureau</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                        <form method="POST" action="add-achat-fournitures-bureau.php">
                        <div class="row">
                        <div class="col-md-6">
...
achat fournitures bureau a été Ajouter success
</div>
<?php } ?>
<div class="col">
<h3 class="page-title">achat fournitures bureau</h3>
</div>
...
<div class="table-responsive">
    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped" id="myTable">
        ...
        <tbody>
            ...
            $query = "SELECT achat_fournitures_bureau.id, achat_fournitures_bureau.designation, achat_fournitures_bureau.quantite, achat_fournitures_bureau.prix_unitaire, achat_fournitures_bureau.prix_global, achat_fournitures_bureau.date_acquisition, achat_fournitures_bureau.affectation, achat_fournitures_bureau.observation, achat_fournitures_bureau.n_convention
            FROM achat_fournitures_bureau
            INNER JOIN convention ON convention.n_convention = achat_fournitures_bureau.n_convention
            INNER JOIN centre ON centre.id = convention.centre_id
            INNER JOIN _admin ON _admin.centre_id = centre.id
            INNER JOIN _user ON _user.id = _admin.user_id
            WHERE _user.username = '$username'
             and achat_fournitures_bureau.n_convention = '$searchConvention'";
            } else {
                $query = "SELECT achat_fournitures_bureau.id, achat_fournitures_bureau.designation, achat_fournitures_bureau.quantite, achat_fournitures_bureau.prix_unitaire, achat_fournitures_bureau.prix_global, achat_fournitures_bureau.date_acquisition, achat_fournitures_bureau.affectation, achat_fournitures_bureau.observation, achat_fournitures_bureau.n_convention
            FROM achat_fournitures_bureau
            INNER JOIN convention ON convention.n_convention = achat_fournitures_bureau.n_convention
