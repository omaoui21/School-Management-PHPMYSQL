...
$username=$_SESSION['username'];
    ...
    $sql = "SELECT filiere.nom_filiere ,filiere.id,filiere.centre_id
    FROM filiere
    ...
    $_SESSION['filiere_sql_query']=$sql;
...
<title>ShemsyMassar - Filiéres</title>
...
if (isset($_GET['success']) && $_GET['success'] == "ajouter") {
    echo '<div class="alert alert-success" role="alert">
              Filiere a été Ajouter success
          </div>';

    echo '<script>
              if (typeof window.history.replaceState === "function") {
                  window.history.replaceState({}, "", "filiere.php");
              }
          </script>';
}
?>
...
<a href="filiere-pdf.php" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Download</a>
<a href="add-filiere.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
</div>
</div>
</div>
...
<td>
<h2>
<a><?php echo $filiere['nom_filiere']; ?></a>
</h2>
</td>
<td><?php
