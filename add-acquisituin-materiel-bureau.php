...
if (isset($_POST['add'])) {
    ...
    $query = "INSERT INTO acquisituin_materiel_bureau (designation, quantite, prix_unitaire, prix_global, date_acquisition, affectation, observation, n_convention) VALUES ('$designation', '$quantite', '$prix_unitaire', '$prix_global', '$date_acquisition', '$affectation', '$observation', '$n_convention')";

    // Execute the query
    if (mysqli_query($conn, $query)) {
        header('Location:add-acquisituin-materiel-bureau.php?success=ajouter');
    } else {
        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Ajouter acquisituin materiel bureau</h3>
                        <ul class="breadcrumb">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                        <form method="POST" action="add-acquisituin-materiel-bureau.php">
                        <div class="row">
                        <div class="col-md-6">
...
acquisituin materiel bureau a été Ajouter success
</div>
<?php } ?>
<div class="col">
...
<div class="table-responsive">
    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped" id="myTable">
        ...
        <tbody>
            ...
            $query = "SELECT acquisituin_materiel_bureau.id, acquisituin_materiel_bureau.designation, acquisituin_materiel_bureau.quantite, acquisituin_materiel_bureau.prix_unitaire, acquisituin_materiel_bureau.prix_global, acquisituin_materiel_bureau.date_acquisition, acquisituin_materiel_bureau.affectation, acquisituin_materiel_bureau.observation, acquisituin_materiel_bureau.n_convention
            FROM acquisituin_materiel_bureau
            INNER JOIN convention ON convention.n_convention = acquisituin_materiel_bureau.n_convention
            INNER JOIN centre ON centre.id = convention.centre_id
            INNER JOIN _admin ON _admin.centre_id = centre.id
            INNER JOIN _user ON _user.id = _admin.user_id
            WHERE _user.username = '$username'
             and acquisituin_materiel_bureau.n_convention = '$searchConvention'";
            } else {
                $query = "SELECT acquisituin_materiel_bureau.id, acquisituin_materiel_bureau.designation, acquisituin_materiel_bureau.quantite, acquisituin_materiel_bureau.prix_unitaire, acquisituin_materiel_bureau.prix_global, acquisituin_materiel_bureau.date_acquisition, acquisituin_materiel_bureau.affectation, acquisituin_materiel_bureau.observation, acquisituin_materiel_bureau.n_convention
                FROM acquisituin_materiel_bureau
                INNER JOIN convention ON convention.n_convention = acquisituin_materiel_bureau.n_convention
