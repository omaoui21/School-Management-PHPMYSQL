...
if (isset($_POST['add'])) {
    ...
    $query = "INSERT INTO acquisituin_materiel_didactique (designation, quantite, prix_unitaire, prix_global, date_acquisition, affectation, observation, n_convention) VALUES ('$designation', '$quantite', '$prix_unitaire', '$prix_global', '$date_acquisition', '$affectation', '$observation', '$n_convention')";

    // Execute the query
    if (mysqli_query($conn, $query)) {
        header('Location:add-acquisituin-materiel-didactique.php?success=ajouter');
    } else {
        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Ajouter acquisituin materiel didactique</h3>
                        <ul class="breadcrumb">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                        <form method="POST" action="add-acquisituin-materiel-didactique.php">
                        <div class="row">
                        <div class="col-md-6">
...
acquisituin materiel didactique a été Ajouter success
</div>
<?php } ?>
<div class="col">
...
<div class="table-responsive">
    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped" id="myTable">
        ...
        <tbody>
            ...
            $query = "SELECT acquisituin_materiel_didactique.id, acquisituin_materiel_didactique.designation, acquisituin_materiel_didactique.quantite, acquisituin_materiel_didactique.prix_unitaire, acquisituin_materiel_didactique.prix_global, acquisituin_materiel_didactique.date_acquisition, acquisituin_materiel_didactique.affectation, acquisituin_materiel_didactique.observation, acquisituin_materiel_didactique.n_convention
            FROM acquisituin_materiel_didactique
            INNER JOIN convention ON convention.n_convention = acquisituin_materiel_didactique.n_convention
            INNER JOIN centre ON centre.id = convention.centre_id
            INNER JOIN _admin ON _admin.centre_id = centre.id
            INNER JOIN _user ON _user.id = _admin.user_id
            WHERE _user.username = '$username'
            and acquisituin_materiel_didactique.n_convention = '$searchConvention'";
            } else {
                $query = "SELECT acquisituin_materiel_didactique.id, acquisituin_materiel_didactique.designation, acquisituin_materiel_didactique.quantite, acquisituin_materiel_didactique.prix_unitaire, acquisituin_materiel_didactique.prix_global, acquisituin_materiel_didactique.date_acquisition, acquisituin_materiel_didactique.affectation, acquisituin_materiel_didactique.observation, acquisituin_materiel_didactique.n_convention
            FROM acquisituin_materiel_didactique
            INNER JOIN convention ON convention.n_convention = acquisituin_materiel_didactique.n_convention
