...
Centre a été Ajouter success
</div>
<?php } ?>
<div class="col">
<h3 class="page-title">Centre</h3>
<ul class="breadcrumb">
...
<a href="centre-pdf.php" class="btn btn-outline-primary me-2" ><i class="fas fa-download"></i> Download</a>
<a href="add-centre.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
</div>
</div>
</div>
...
<td>
<h2>
<a><?php echo $centre['nom']; ?></a>
</h2>
</td>
<td><?php echo $centre['adresse']; ?></td>
...
<script>
  document.getElementById('downloadBtn').addEventListener('click', function() {
    const element = document.getElementById('yourTableId'); // Replace 'yourTableId' with the actual ID of your table element
