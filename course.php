...
if ($_SESSION['role'] == 'etudiant') {
    ...
    $filiereId = $row['filiere_id'];
       ...
       $sql= "SELECT course.id, course.nom, course.description, course.file_course, module.nom_module
       FROM course
...
if (isset($_GET['success']) && $_GET['success'] == "ajouter") {
    echo '<div class="alert alert-success" role="alert">
              course a été Ajouter success
          </div>';

    echo '<script>
              if (typeof window.history.replaceState === "function") {
                  window.history.replaceState({}, "", "course.php");
              }
          </script>';
}
?>
...
<?php  if ($_SESSION['role'] == 'formateur') {?><a href="add-course.php" class="btn btn-primary"><i class="fas fa-plus"></i></a><?php }?>
</div>
</div>
</div>
